  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 text-center">
        <h1 className="text-5xl font-bold mb-4 text-blue-700">About <span className="italic"> Celeris AutoComp </span> </h1>
        <p className="text-xl text-gray-700 max-w-3xl italic mx-auto">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-8 text-lg text-gray-700 leading-relaxed">
                ...
                <p className="text-center italic text-gray-800 text-xl mb-8">
                ...
                <div className="bg-white p-8 rounded-sm shadow-lg border border-gray-200 my-12">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">A Startup with Big Ambition</h3>
                  <p className="mb-4">
                ...
                <div className="bg-white p-8 rounded-sm shadow-lg border border-gray-200 my-12">
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">Built for the Next Generation</h3>
                  <p className="mb-4">
